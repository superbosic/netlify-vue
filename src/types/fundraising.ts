...
export type FundraisingRoundInvestorInput = Parameters<Fundraising['roundInvestorCreate']>[0];
export type RoundListItem = NonNullable<ExtractHttpResponseType<ReturnType<Fundraising['roundList']>>['data']>;
export type InvestorsListItem = NonNullable<NonNullable<RoundListItem['investors']>[0]>;
